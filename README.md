# LiveEventBus
![license](https://img.shields.io/github/license/JeremyLiao/LiveEventBus.svg) [![version](https://img.shields.io/badge/JCenter-v1.5.6-blue.svg)](https://mvnrepository.com/artifact/com.jeremyliao/live-event-bus)
...
```
implementation 'com.jeremyliao:live-event-bus:1.5.6'
```
For AndroidX:
```
